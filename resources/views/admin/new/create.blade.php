...
@section('content')
    <div class="container">
        <h2 style="color: #000">Tạo tin tức mới</h2>

        <div class="form-container">
            <form action="{{ route('admin.storeNew') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-group">
                    ...
                    <textarea class="form-input"  id="sort" name="sort" rows="3" placeholder="Nhập mô tả s lược ...">{{ old('sort') }}</textarea>
                    @error('sort')
                    <div style="color:#e11d48;font-size:12px">{{ $message }}</div>
                    @enderror
                </div>
