...
@section('content')
    <div class="container">
        <h2 style="color:#000">Chỉnh sửa thiết kế sản phẩm</h2>

        <div class="form-container">
            <form id="designForm" action="{{ route('admin.updateDesginProduct', $post->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="input-group">
                    ...
                    <textarea id="description" name="description" rows="8" placeholder="Nhập mô tả...">{!! old('description', $post->description) !!}</textarea>
