...
@section('content')
    <div class="container">
        <h2 style="color: #000">Giới thiệu công ty</h2>

        <div class="form-container">
            <form action="{{ route('admin.updateCompany',['id'=>1]) }}" method="POST">
                @method('PUT')
                @csrf
                ...
                <div class="input-group">
                    ...
                    <textarea id="description" name="description" rows="8" placeholder="Nhập mô tả...">{!! old('description', $product['description']) !!}</textarea>
                    @error('description')
