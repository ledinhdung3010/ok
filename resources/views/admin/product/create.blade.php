...
@push('style')
    <style>body {
        ...
        .btn-cancel:hover {
            background-color: #c0392b;
        }/* Chỉnh kiểu cho select2 */
        .select2-container {
            width: 100% !important; /* Đảm bảo độ rộng đầy đủ */
        }
        .select2-selection {
            padding: 8px 12px;
        }
...
@section('content')
    <div class="container">
        <h2 style="color: #000">Tạo sản phẩm mới</h2>
        ...
        <div class="form-container">
            <form action="{{ route('admin.storeProduct') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="text" value="{{ old('title') }}" name="title" placeholder="Nhập tiêu đề" required>
                    @error('title')
                ...
                <div class="input-group">
                    ...
                    <textarea id="description" name="desc" rows="8" placeholder="Nhập mô tả...">{{ old('desc') }}</textarea>
                    @error('desc')
                    <div style="color:#e11d48;font-size:12px">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="input-group">
                    ...
                    <select name="category_id[]" id="categories" class="text-dark form-control select2 @error('category') is-invalid @enderror" multiple>
